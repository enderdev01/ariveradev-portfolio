...
export default function Hero() {
  return (
    ...
    >
      ...
      <div
        className="absolute inset-0 z-10 bg-gradient-to-b from-[#080616]/70 via-transparent to-[#080616]/80"
        aria-hidden="true"
      />
      ...
      <div className="relative z-20 max-w-5xl mx-auto px-4 text-center">
        ...
        <p className="animate-fade-in-up stagger-3 text-base sm:text-lg md:text-xl text-text-secondary/90 max-w-2xl mx-auto mb-10 leading-relaxed font-light">
        ...
        <div className="animate-fade-in-up stagger-4 flex flex-col sm:flex-row gap-4 justify-center items-center">
          <a
            href="#contactanos"
            className="group relative px-8 py-4 bg-primary-fill text-white rounded-full font-bold text-lg overflow-hidden transition-all duration-base ease-out-expo hover:scale-[1.02] hover:shadow-[0_0_30px_rgba(47,47,228,0.55)] active:scale-[0.97] shadow-[0_0_20px_rgba(47,47,228,0.45)] focus-visible:outline-white"
          >
      ...
      <div className="absolute bottom-8 left-1/2 -translate-x-1/2 z-20 animate-fade-in stagger-4">
        <div className="animate-scroll-drift flex flex-col items-center gap-2 opacity-60 hover:opacity-100 transition-opacity">
